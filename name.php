...
<script language="javascript" type="text/javascript" src="javascript/valname.js"></script>
...
$query ="select * from reservation where name = '$name' ORDER BY time ASC";
...
?>
                 ...
                 <form action="name.php" method="get" onsubmit="return ValidateForm(this);">
                    Please Enter Name:  <input type="text" size="20" name="name"/>
