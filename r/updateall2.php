...
<script language="javascript" type="text/javascript" src="javascript/valevery.js"></script>
...
?>
                ...
                Enter the details below to Update a reservation
               <table>
          <form action="updateall.php" method="get" onsubmit="return ValidateForm(this);">
                      ...
                      <tr><td>Enter Details Below to Update the information</td></tr>
                          <tr>
                      <td>Enter Name:</td> 
