...
<script language="javascript" type="text/javascript" src="javascript/valupdatedate.js"></script>
...
?>
               ...
               <table>
          <form action="updatedate.php" method="get" onsubmit="return ValidateForm(this);" >
                     <tr>
