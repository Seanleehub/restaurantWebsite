...
<script language="javascript" type="text/javascript" src="javascript/valnametable.js"></script>
...
<div id="leftleft">
    ...
    <div id="rightcontent">
      <h2><!-- InstanceBeginEditable name="header" -->List of reservations by 
<?php
$name=$_GET['name'];
$tablenum=$_GET['tablenum'];

print "$name and table number $tablenum";
...
$query ="select * from reservation where name = '$name' and tablenum = $tablenum ORDER BY time ASC";
...
?>
                 ...
                 <form action="tableandname.php" method="get" onsubmit="return ValidateForm(this);">
                    Please Enter Name:  <input type="text" size="20" name="name"/><br />

                     Please Enter Table Number:  <input type="text" size="20" name="tablenum"/><br />
