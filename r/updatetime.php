...
<script language="javascript" type="text/javascript" src="javascript/valtime.js"></script>
...
?>
               ...
               <table>
          <form action="updatetime2.php" method="get" onsubmit="return ValidateForm(this);">
                     <tr>
