		...
		function Validatetablenum(tnum) {
			...
			function ValidateForm(formObj) {
				...
				pnum = formObj.enterphone.value;
				time = formObj.entertime.value;
				pax = formObj.enterpax.value;
				date = formObj.enterdate.value;
				tnum = formObj.entertablenum.value;
				...
				if(!Validatetablenum(tnum))  {
				    formObj.entertablenum.select();
				    return false;
				}
