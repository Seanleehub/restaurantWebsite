...
<script language="javascript" type="text/javascript" src="javascript/valnamenum.js"></script>
...
print "$name and phone number is $phonenum";
...
$query ="select * from reservation where name = '$name' and phonenum = $phonenum ORDER BY time ASC";
...
?>
                 ...
                 <form action="nameandnumber.php" method="get" onsubmit="return ValidateForm(this);">
                    Plesae Enter Name:  <input type="text" size="20" name="name"/><br />

                     Please Enter Number:  <input type="text" size="20" name="phonenum"/><br />
